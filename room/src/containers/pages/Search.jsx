...
import { get_room_list, get_room_list_page, search_room, search_room_page } from "redux/actions/room/room"
...
function Search({
    ...
    return(
        <Layout>
            ...
            <meta name="description" content="Luxury hotel accessible to everyone. Come and Feel Free."/>
